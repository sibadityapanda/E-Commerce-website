...
const products = [
  ...
  { name: 'iFlight Nazgul5 V2 5" FPV', price: 259.99, image: '/images/nazgul_drone.png', description: 'High-performance 5-inch freestyle quadcopter built for durability and speed.', countInStock: 8 },
  { name: 'GEPRC CineLog35 HD', price: 349.99, image: '/images/cinelog_drone.png', description: '3.5-inch pusher cinewhoop perfect for carrying a full-size GoPro camera.', countInStock: 5 },
  { name: 'BetaFPV Pavo30 Whoop Quadcopter', price: 199.99, image: '/images/cinelog_drone.png', description: 'A 3-inch pusher whoop with extreme maneuverability and power.', countInStock: 12 },
  { name: 'TBS Tango 2 Pro FPV Radio', price: 199.99, image: '/images/tango_radio.png', description: 'Compact, high-quality radio controller with built-in Crossfire micro TX.', countInStock: 20 },
  { name: 'Fat Shark HDO2 FPV Goggles', price: 499.99, image: '/images/fatshark_goggles.png', description: 'OLED displays provide incredible color and contrast for analog and digital FPV.', countInStock: 7 },
  ...
  { name: 'Xilinx Spartan-7 FPGA Kit', price: 149.99, image: '/images/xilinx_fpga.png', description: 'Cost-optimized FPGA development board with extensive I/O.', countInStock: 14 },
  { name: 'Rigol DS1054Z Oscilloscope', price: 349.99, image: '/images/rigol_scope.png', description: '50 MHz, 4-channel digital oscilloscope with advanced trigger functions.', countInStock: 6 },
  { name: 'Siglent SDG1032X Function Generator', price: 359.99, image: '/images/siglent_gen.png', description: 'Dual-channel arbitrary waveform generator.', countInStock: 8 },

  // Analog Communication Testing
  { name: 'Keysight N9320B Spectrum Analyzer', price: 2995.00, image: '/images/keysight_analyzer.png', description: '9 kHz to 3 GHz basic spectrum analyzer for RF testing.', countInStock: 2 },
  ...
  { name: 'Hakko FX-888D Soldering Station', price: 109.99, image: '/images/hakko_soldering.png', description: 'Reliable digital soldering station with excellent thermal recovery.', countInStock: 15 },
  { name: 'TS100 Portable Soldering Iron', price: 65.99, image: '/images/ts100_iron.png', description: 'Smart, programmable soldering iron perfect for field repairs.', countInStock: 22 },
  ...
  { name: 'Pinecil Smart Mini Soldering Iron', price: 25.99, image: '/images/pinecil_iron.png', description: 'RISC-V based mini portable soldering iron featuring 32-bit SOC.', countInStock: 50 },
  { name: 'Owon B35T+ Bluetooth Multimeter', price: 55.99, image: '/images/owon_multimeter.png', description: 'Digital multimeter with offline recording function and Bluetooth.', countInStock: 14 },

  // Additional Hobbyist Boards & Components
  { name: 'Raspberry Pi 4 Model B (8GB)', price: 85.00, image: '/images/raspberry_pi.png', description: 'High-performance microcomputer with 8GB RAM for demanding projects.', countInStock: 35 },
  ...
  { name: 'Caddx Vista Nebula Pro Kit', price: 165.00, image: '/images/radio.png', description: 'Digital FPV transmission system supporting 120fps.', countInStock: 10 }
];
